...
public class T05_CollectionSort {
    public static void main(String[] args) {
        ...
        ///////////////////////////////////////////////////////////////////////////////////
        if (false) {
            //NOTE: Arrays.asList : 변경(set)만 가능
        ...
        if (false) {
            ...
            //NOTE: removeIf(Predicate<? super E> filter)
        ...
        if (false) {
            ...
            //NOTE: sort(Comparator<? super E> c)
        ...
        if (true) {
            ...
            //NOTE: FirstName정열 후 LastName정열 한방에...
